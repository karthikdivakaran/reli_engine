...
from PyQt5.QtWidgets import QApplication, QWidget, QStyledItemDelegate, QPushButton, QHeaderView, QStyleOptionButton, \
...
# add reresh components and rename as refresh user here
    ...
    def confirm_delete(self, row):
        ...
        if user_data.get("Role") in ["Admin"]:
            QMessageBox.warning(self, "Admin User", "Can't delete admin user.")
        else:
